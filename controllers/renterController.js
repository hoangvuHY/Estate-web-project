...
async function getFavoritePostController(req, res) {
  await getFavoritePostService(req.body.idRenter)
...
function addSeenPostController(req, res) {
  addSeenPostService(req.body.idPost)
    .then(function (result) {
      if (result) {
        return res.json({
          error: false,
...
function saveFavoritePostController(req, res) {
  saveFavoritePostService(req.body.idPost, req.body.idRenter)
    .then(function (result) {
      if (result) {
        return res.json({
          error: false,
...
function findPostProvinceController(req, res) {
  findPostProvinceService(req.body.province)
    .then(function (result) {
      return res.json({
        error: false,
        status: 200,
...
function getAllPostListController(req, res) {
  ...
  allPostService(Number(req.body.n))
    .then(function (result) {
      if (result) {
        return res.json({
          error: false,
...
function getDetailPostController(req, res) {
  findPostService(req.params.idPost)
    .then(function (result) {
      if (result) {
        return res.json({
          error: false,
