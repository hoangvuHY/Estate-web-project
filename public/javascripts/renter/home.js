...
$(document).on(
  "click",
  ".mom-article .carousel-item .title-article",
  function () {
    location.assign(`/detail/${$(this).attr("idpost")}`);
    Cookies.set("idPost", $(this).attr("idpost"));
  }
...
$("#search").on("click", function () {
  ...
  let binh_nong_lanh =
    $("#binh-nong-lanh:checked").val() == "yes" ? "Yes" : "No";
    ...
    result.data.forEach((article, index) => {
      ...
      <div class="carousel-item ${index == 0 ? "active" : ""}">
         <div class="col-md-4">
           ...
           <img class="img-fluid" src=${article.images_room[0]} idpost=${
          article._id
        }>
          ...
          new Date(article.createdAt).getMonth() + 1
               ...
               <div class="col-3 text-right">
                  <i class="far fa-heart pointer" id="like" idpost=${
                    article._id
